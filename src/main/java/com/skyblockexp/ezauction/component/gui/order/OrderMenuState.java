...
public class OrderMenuState {
    ...
    public OrderMenuState(ItemStack template, double pricePerItem, int quantity, int durationIndex,
        ...
        this.debugEnabled = EzAuctionPlugin.getStaticRegistry().configuration.debug();
        logDebug("OrderMenuState created: item=" + template + ", pricePerItem=" + pricePerItem + ", quantity=" + quantity + ", durationIndex=" + durationIndex);
    }
